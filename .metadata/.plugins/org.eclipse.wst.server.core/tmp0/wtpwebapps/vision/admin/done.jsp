...
%>
  ...
  <tr>
  <td style="font-family: cursive;font-size: x-large;font-weight: bold;color: Orange"><%= rs.getString("NAME") %></td>
 </tr>
 <tr>
  <td style="color: White;font-family: cursive;font-size: medium;text-align: justify;"><%= rs.getString("DESCRIPTION") %></td>
 </tr>
 <tr>
  <td><img height="200px" width="200px" src="admin/show.jsp" > </td>
 </tr>
