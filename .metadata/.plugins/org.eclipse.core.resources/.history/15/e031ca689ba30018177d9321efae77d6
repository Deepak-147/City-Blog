...
function init() {
   ...
   document.getElementById("hotelentry").onsubmit = validateAdminhotelentryForm;
...
function validateAdminhotelentryForm() 
{
   return ( 
		        notEmpty("hotelname", "Please Enter Hotel Name!")
                && isNotEmpty("hoteldescription", "Description Field can't be left blank!")
          );
}
