...
<script type='text/Javascript' src="/vision/user/js files/user_login.js"></script>
<style>
#indiv tr td a {
    float: left;
	display: block;
...
<tr>
 ...
 <td width="150"class='height' id="usrnameError">&nbsp; </td>
...
<tr>
 ...
 <td width="150"class='height' id="passwordError">&nbsp; </td>
