...
<title>Information Resource</title>
<style>
/* hover div*/
#indiv tr td a {
    float: left;
 ...
 <tr height='50' >
  <td>
   <table id='indiv' align="center"><!--table 2 inside table 1-->
     <tr>
	  <td><a href='/vision/user/jsp files/index/index.jsp' target='_parent'>HOME</a></td>
      <td><a href='/vision/user/jsp files/index/about_us.jsp' target='_parent'>ABOUT US</a></td>
      <td><a href='/vision/user/jsp files/index/contact_us.jsp' target='_parent'>CONTACT US</a></td>
      <td><a href='/vision/user/jsp files/index/information.jsp' target='_top' class='current'>INFORMATION RESOURCE</a></td>
      <td><a href='/vision/user/jsp files/index/features.jsp' target='_parent'>FEATURES</a></td>
